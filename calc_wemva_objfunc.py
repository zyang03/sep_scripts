...
# (x,y,z,gamma,azim) -> transp -> (z,gamma,azim,x,y)\n'''
        ...
        cmd3 = "time Window3d <%s/t6.H n1=%s n2=%s n3=%s >%s/t7.H IOtype=c2r datapath=%s/" % (path_tmp, ax_x[0],ax_y[0],ax_z[0], path_tmp, path_tmp)
    ...
    sepbase.put_sep_axis_params(fn_img_ang,1,ax_z)
    sepbase.put_sep_axis_params(fn_img_ang,4,ax_x)
    sepbase.put_sep_axis_params(fn_img_ang,5,ax_y)
...
# (x,y,z,hx,hy) -> Transp -> (hx,hy,x,y,z)\n'''
        ...
        cmd2 = "time %s/YFt3d <%s/t5.H nth=8 sign1=-1 sign2=-1 sign3=-1 >%s/t6.H IOtype=c2r datapath=%s/" % (dict_args['YANG_BIN'], path_tmp, path_tmp, path_tmp)
        cmd3 = ("time Window3d <%s/t6.H n1=%s n2=%s n3=%s n4=%d n5=%d >%s/t7.H datapath=%s/" %
                (path_tmp, ax_x[0],ax_y[0],ax_z[0], nhx,nhy, path_tmp, path_tmp))
